...
export const newsItemsData: NewsItem[] = [
  ...
  },
  {
    ...
    D4Image2: "/services/Recovery.jpg",
    D4Data:
      "The foredeck and the hull section was insufficiently bonded together when the boat as built in 2011. A detailed analysis indicated that: . Less than 10% of the bonding surfaces showed signs of aggravated rupture by splintering or de-lamination, indicating that they were incorrectly bonded at build stage . The GRP (glassreinforced plastic or fibre-glass) bonding was likely to have been incorrectly performed due to the restricted space available in the foredeck . The vessel had undergone a competent and third party inspection that had concluded that no structural defects were identified in the GRP construction.The cause of the incident was found to be a material failure of the hull as a result of insufficient bonding during the build phase of the vessel. Whilst the weather, as with most marine operations, was an influence, this was not a major contributing factor given that hull",
  },
  {
    title: "UK HSE: Offshore crane boom hoist failures",
    date: "10 Febr 2022",
    ...
    D3Title:
      "The UK Health and Safety Executive (HSE) has published the following safety alert covering two recent crane incidents in which the crane boom upper hoist limit systems failed to prevent the crane booms from being hoisted up too far and against the boom backstops.",
    D1Data:
      "The UK HSE (Health and Safety Executive) have published an alert relating to two incidents that occurred offshore, involving the failure of crane boom hoist ropes, resulting in the crane booms falling onto the deck below.",
    D4Image1: "/services/Prevention.jpg",
    D4Image2: "/services/Recovery.jpg",
    D4Data:
      "The continued hoisting resulted in the booms fully compressing the boom backstops, causing high loading on the boom upper main chords with the eventual catastrophic failure of the booms. Measures should be in place to verify the correct operation and the correct settings of all safety systems and limits on offshore cranes.",
