...
const Hero = () => {
  return (
    <div className=" relative  rounded-xl md:rounded-[50px]  h-[75vh] overflow-hidden mt-10 md:mt-14 shadow-customHeroShadow mx-4 ">
      <div>
        <video
      ...
      <div className=" container absolute bottom-6 right-0 p-4 pb-10 left-1/2 transform -translate-x-1/2 w-[90%] ">
        <div>
        ...
        <div className=" flex flex-col sm:flex-row sm:items-end justify-between gap-4 mt-14">
          <p className=" text-[#232A20] text-xl md:text-2xl">
